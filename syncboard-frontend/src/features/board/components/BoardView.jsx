        ...
        <header className="h-14 border-b border-gray-200 bg-white flex items-center justify-between px-6 flex-shrink-0 z-10">
          ...
          <div className="h-16 border-b border-gray-200 bg-white flex items-center justify-between px-6 flex-shrink-0 z-10">
            <div className="flex items-center gap-4">
              <h2 className="text-xl font-bold text-gray-900 flex items-center gap-3">
                ...
                {isEditingTitle ? (
                  ...
                  <span 
                    ...
                    className="cursor-pointer hover:bg-gray-100 px-1 rounded rounded-sm"
              ...
              <div className="flex items-center gap-3">
                <div className="flex -space-x-2">
                  ...
                  {/* +1 placeholder like mockup */}
                  <div className="w-8 h-8 rounded-full bg-indigo-50 border-2 border-white flex items-center justify-center text-xs font-semibold text-indigo-600 z-10">
                    +1
                  </div>
                </div>
            ...
            <div className="flex items-center gap-3">
              ...
              <button className="px-2 py-1.5 text-gray-700 border border-gray-300 bg-white hover:bg-gray-50 rounded-md transition-colors">
              ...
              <div className="p-5 flex-1 overflow-y-auto">
                ...
                <div className="space-y-6">
                  ...
                  <div className="flex gap-3">
                    ...
                    <div>
                      <p className="text-sm text-gray-600 leading-snug">
                        <span className="font-semibold text-gray-900">Rohit Sharma</span> moved "Code review: Auth module" to <span className="font-semibold text-gray-900">Review</span>
                      </p>
                      <span className="text-xs text-gray-400 mt-1 block">2m ago</span>
                    </div>
                  </div>
                  ...
                  <div className="flex gap-3">
                    ...
                    <div>
                      <p className="text-sm text-gray-600 leading-snug">
                        <span className="font-semibold text-gray-900">Sneha Patil</span> commented on "Homepage UI review"
                      </p>
                      <span className="text-xs text-gray-400 mt-1 block">5m ago</span>
                    </div>
                  </div>
                  ...
                  <div className="flex gap-3">
                    ...
                    <div>
                      <p className="text-sm text-gray-600 leading-snug">
                        <span className="font-semibold text-gray-900">Ananya Desai</span> updated due date for "Create style guide"
                      </p>
                      <span className="text-xs text-gray-400 mt-1 block">12m ago</span>
                    </div>
                  </div>
                </div>
              </div>
