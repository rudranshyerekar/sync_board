...
| **Boards: Get Members** | `/api/boards/{boardId}/members` | GET | Yes | [boardApi.js](file:///d:/Project/sync_board/syncboard-frontend/src/api/boardApi.js) | [BoardSingleController.java](file:///d:/Project/sync_board/syncboard-backend/src/main/java/com/syncboard/board/controller/BoardSingleController.java) | ✅ Matched |
| **Boards: Add Member** | `/api/boards/{boardId}/members` | POST | Yes | [boardApi.js](file:///d:/Project/sync_board/syncboard-frontend/src/api/boardApi.js) | [BoardSingleController.java](file:///d:/Project/sync_board/syncboard-backend/src/main/java/com/syncboard/board/controller/BoardSingleController.java) | ✅ Matched |
| **Boards: Remove Member** | `/api/boards/{boardId}/members/{userId}` | DELETE | Yes | [boardApi.js](file:///d:/Project/sync_board/syncboard-frontend/src/api/boardApi.js) | [BoardSingleController.java](file:///d:/Project/sync_board/syncboard-backend/src/main/java/com/syncboard/board/controller/BoardSingleController.java) | ✅ Matched |
